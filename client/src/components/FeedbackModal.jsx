            ...
            {isOpen && (
                <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
                    <motion.div 
                        ...
                        className="bg-white p-8 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative"
                                    ...
                                    {field.type === 'textarea' ? (
                                        ...
                                        <div className="flex flex-wrap gap-4">
                                            {field.options && field.options.map(opt => (
                                                <label key={opt} className="flex items-center gap-2 cursor-pointer bg-gray-50 px-4 py-2 rounded-xl border hover:bg-white transition-all">
                                                    <input
                                                        type="radio"
                                                        name={field.label}
                                                        value={opt}
