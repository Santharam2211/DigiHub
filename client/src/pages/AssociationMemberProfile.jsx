...
const statusConfig = {
    Pending:  { color: 'bg-amber-50 text-amber-600 border-amber-100',  Icon: Clock,         dot: 'bg-amber-400' },
    Approved: { color: 'bg-emerald-50 text-emerald-600 border-emerald-100', Icon: CheckCircle, dot: 'bg-emerald-400' },
    Rejected: { color: 'bg-red-50 text-red-600 border-red-100',        Icon: XCircle,       dot: 'bg-red-400' }
};
                ...
                {activeTab === 'Profile' && (
                    ...
                    >
                        <form onSubmit={handleSubmit} className="p-10 space-y-10">
                            ...
                            {/* Identity (read-only) */}
                            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100 grid md:grid-cols-4 gap-4 text-sm font-bold text-slate-700">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-violet-600 font-black">{user?.associationRole || 'Volunteer'}</span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-3 gap-6">
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Roll / Reg Number</label>
                                        <div className="relative">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-lg font-black text-slate-900">About & Skills</h2>
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Bio <span className="font-normal normal-case tracking-normal text-slate-300">({formData.bio.length}/500)</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Skills & Expertise</label>
                                    <div className="relative">
                                    ...
                                    {formData.skills && (
                                        <div className="flex flex-wrap gap-2 pt-1">
                                            {formData.skills.split(',').map((s, i) => s.trim() && (
                                                <span key={i} className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-xs font-black border border-indigo-100">
                                                    {s.trim()}
                                                </span>
                                            ))}
                                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-6 items-start">
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Upload Signature</label>
                        ...
                        <div className="p-10">
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-black text-slate-900">Volunteer Applications</h2>
                                ...
                                <div className="flex gap-2">
                                    {[
                                        { label: 'Pending', count: pendingCount, color: 'bg-amber-50 text-amber-600 border-amber-100' },
                                        { label: 'Approved', count: approvedCount, color: 'bg-emerald-50 text-emerald-600 border-emerald-100' },
                                        { label: 'On-Duty', count: onDutyCount, color: 'bg-indigo-50 text-indigo-600 border-indigo-100' },
                                    ].map(p => p.count > 0 && (
                            ...
                            {appsLoading ? (
                                ...
                                <div className="space-y-4">
                                    {volunteerApps.map(app => {
                                        ...
                                        const { Icon } = cfg;
                                        return (
                                            <div key={app._id} className="p-6 bg-slate-50 hover:bg-slate-100/80 rounded-[2rem] border border-slate-100 flex flex-wrap items-center justify-between gap-5 transition-colors group">
                                                <div className="flex items-center gap-5">
                                                    <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm border border-slate-100 group-hover:shadow-md transition-shadow">
                                                        <Calendar className="w-7 h-7 text-indigo-400" />
                                                    </div>
                                                    <div>
                                                        <h3 className="font-black text-slate-900 text-lg leading-tight">{app.event?.title || 'Unnamed Event'}</h3>
                                                ...
                                                <div className="flex items-center gap-3 flex-wrap">
                                                    {app.onDutyIssued && (
                                                        <span className="flex items-center gap-1.5 bg-indigo-50 text-indigo-700 border border-indigo-100 px-3 py-1.5 rounded-full text-xs font-black">
                            ...
                            {/* Info card */}
                            <div className="mt-8 p-6 bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-100/80 rounded-3xl flex items-start gap-4">
                                <div className="w-9 h-9 bg-indigo-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <FileText className="w-4 h-4 text-indigo-600" />
                                </div>
                                <div>
                                    <h3 className="font-black text-indigo-900 text-sm mb-1">How On-Duty Works</h3>
