    ...
    useEffect(() => {
        const fetchHomeData = async () => {
            try {
                ...
                setAssociationMembers(membersRes.data);
            } catch (error) {
        ...
        <div className="space-y-40 pb-40 overflow-hidden">
            ...
            <section className="container mx-auto px-6 space-y-20">
                <div className="text-center space-y-4">
                    <h2 className="text-5xl font-black text-slate-900 tracking-tight">Our Core <span className="text-reveal">Initiatives</span></h2>
                    <p className="text-slate-500 text-lg font-medium">Fostering technical excellence through engaging community activities.</p>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {/* Large Feature */}
                    <div className="md:col-span-2 group relative overflow-hidden bg-gradient-to-br from-white to-slate-50 rounded-[3rem] p-12 border border-slate-100 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2 transition-all duration-500">
                        <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/0 via-indigo-500/5 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                        <div className="absolute -top-24 -right-24 opacity-5 transition-transform duration-700 group-hover:scale-125 group-hover:rotate-12">
                        ...
                        <div className="relative z-10 space-y-6 max-w-md">
                            ...
                            <h3 className="text-3xl font-black text-slate-900">Hackathons & Coding Contests</h3>
                            ...
                            <div className="pt-4">
                                <Link to="/events" className="flex items-center gap-2 font-black text-indigo-600 group-hover:gap-4 transition-all">
                    ...
                    <div className="group bg-indigo-600 rounded-[3rem] p-12 text-white shadow-xl shadow-indigo-200 hover:-translate-y-2 transition-all duration-500 flex flex-col justify-between">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-indigo-100 font-medium">Hands-on sessions covering AI, Web3, and emerging technologies.</p>
                        </div>
                    </div>
                    ...
                    <div className="group bg-slate-900 rounded-[3rem] p-12 text-white shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col justify-between">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-slate-400 font-medium">Gain valuable insights from industry leaders and top alumni.</p>
                        </div>
                    </div>

                    <div className="md:col-span-2 group relative bg-gradient-to-br from-white to-slate-50 rounded-[3rem] p-12 border border-slate-100 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2 transition-all duration-500 flex flex-col md:flex-row items-center gap-12 overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/0 via-purple-500/5 to-pink-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                        <div className="relative z-10 space-y-6 max-w-sm shrink-0">
                            <h3 className="text-3xl font-black text-slate-900">Project Showcases</h3>
                            <p className="text-slate-500 text-lg leading-relaxed font-medium">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {events.map((event) => (
                            <Link key={event._id} to={`/events/${event._id}`} className="group">
                                <div className="bg-white rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-lg hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2 transition-all duration-500">
            ...
            {associationMembers.length > 0 && (
                <section className="container mx-auto px-6 space-y-16">
                    <div className="text-center space-y-4">
                        <h2 className="text-5xl font-black text-slate-900 tracking-tight">Our <span className="text-reveal">Team</span></h2>
                        <p className="text-slate-500 text-lg font-medium">The dedicated members driving the association forward.</p>
                    </div>

                    <div className="relative max-w-4xl mx-auto">
                        <div className="overflow-hidden rounded-[3rem] bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 shadow-xl relative min-h-[400px] flex items-center justify-center p-8">
                                ...
                                >
                                    <div className="shrink-0 relative">
                                        ...
                                        {associationMembers[currentMemberIndex]?.profileImage ? (
                                            ...
                                            <div className="w-48 h-48 md:w-64 md:h-64 rounded-full bg-white border-4 border-white shadow-2xl flex items-center justify-center relative z-10 text-indigo-200">
                                                <Users className="w-20 h-20" />
                                            </div>
                                        )}
                                    </div>
                                    <div className="space-y-4 text-center md:text-left">
                                        <div className="inline-block px-4 py-1.5 rounded-full bg-indigo-100 text-indigo-700 font-bold text-sm tracking-wide uppercase">
                                            {associationMembers[currentMemberIndex]?.associationRole || 'Volunteer'}
                                        </div>
                                        <h3 className="text-3xl md:text-4xl font-black text-slate-900">{associationMembers[currentMemberIndex]?.username}</h3>
                            ...
                            <button
                                ...
                                className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/80 backdrop-blur-md rounded-full shadow-lg flex items-center justify-center text-slate-800 hover:bg-white hover:scale-110 transition-all z-20"
                            >
                                <ChevronRight className="w-6 h-6 rotate-180" />
                            </button>
                            <button
                                onClick={handleNextMember}
                                className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/80 backdrop-blur-md rounded-full shadow-lg flex items-center justify-center text-slate-800 hover:bg-white hover:scale-110 transition-all z-20"
                            >
                        ...
                        <div className="flex justify-center gap-2 mt-8">
                            {associationMembers.map((_, idx) => (
                                <button
                                    ...
                                    className={`w-3 h-3 rounded-full transition-all ${idx === currentMemberIndex ? 'bg-indigo-600 w-8' : 'bg-slate-300 hover:bg-slate-400'
                                        }`}
                                />
                            ))}
                        </div>
            ...
            <section className="container mx-auto px-6">
                <div className="bg-indigo-600 rounded-[4rem] p-24 text-center text-white relative overflow-hidden shadow-[0_50px_100px_-20px_rgba(79,70,229,0.4)]">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto space-y-10">
                        <h2 className="text-5xl md:text-6xl font-black leading-tight tracking-tighter">Ready to Spark Your <span className="text-indigo-200">Tech Journey?</span></h2>
                        <p className="text-xl text-indigo-100 font-medium">Be part of the most active tech association on campus. Join {stats.totalRegistrations}+ participants today.</p>
                        <div className="flex justify-center flex-wrap gap-6">
                            <Link to="/events" className="px-12 py-5 bg-white text-indigo-600 rounded-2xl font-black text-lg hover:bg-indigo-50 transition-all active:scale-95 shadow-2xl">
            ...
            <footer className="container mx-auto px-6 py-20 border-t border-slate-100 mt-20">
                <div className="flex flex-col md:flex-row justify-between items-center gap-10">
                    <div className="space-y-4 text-center md:text-left">
                        <h3 className="text-2xl font-black text-slate-900 tracking-tighter">Digi<span className="text-indigo-600">Flash.</span></h3>
                    ...
                    <div className="flex gap-4">
                        {[
                            ...
                            <a
                                key={i}
                                href={social.href}
                                className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-indigo-600 hover:text-white transition-all duration-300 shadow-sm"
