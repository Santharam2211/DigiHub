            ...
            <main className="grid lg:grid-cols-3 gap-12">
                        ...
                        {activeTab === 'new' ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-8">
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            <label className="text-sm font-black text-slate-400 uppercase tracking-widest pl-1">Complaint Subject</label>
                                            <input 
                                                required
                                                type="text" 
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-black text-slate-400 uppercase tracking-widest pl-1">Nature of Ticket</label>
                                            <select 
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm font-black text-slate-400 uppercase tracking-widest pl-1">Detailed Description</label>
                                        <textarea 
                                            required
                            ...
                            >
                                {myQueries.length === 0 ? (
                                    ...
                                    myQueries.map((q) => (
                                        <div key={q._id} className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm space-y-6 hover:shadow-xl transition-all duration-300">
                                            <div className="flex justify-between items-start">
                                                <div className="space-y-1">
                                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">{q.category}</span>
                                                    <h3 className="text-xl font-black text-slate-900">{q.subject}</h3>
                                                </div>
                                            ...
                                            <p className="text-slate-600 font-medium leading-relaxed">{q.message}</p>
                                            
                                            {q.adminRemarks && (
                                                <div className="p-6 bg-indigo-50/50 rounded-2xl border border-indigo-100 space-y-2">
                                                    <p className="text-xs font-black text-indigo-600 uppercase tracking-widest">Admin Response</p>
                                                    <p className="text-slate-700 font-bold">{q.adminRemarks}</p>
                                                </div>
                                            )}
                                            ...
                                            <div className="pt-6 border-t border-slate-50 flex justify-between items-center text-[10px] font-black text-slate-400 uppercase tracking-widest">
                                                ...
                                                <span className="text-indigo-600">REQ-{q._id.slice(-6).toUpperCase()}</span>
                                            </div>
                                        </div>
                                    ))
                                )}
                ...
                <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div 
                                    ...
                                    className="flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors cursor-pointer group"
                                >
                    ...
                    <div className="p-8 bg-white rounded-[2.5rem] border border-slate-100 space-y-4">
                        ...
                        <h3 className="text-lg font-black text-slate-900 leading-tight">Response Time</h3>
                        <p className="text-sm font-medium text-slate-500">Our admin team typically responds within 24-48 business hours.</p>
                    </div>
                </div>
            </main>
        </div>
