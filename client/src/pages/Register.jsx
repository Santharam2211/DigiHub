                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        <option value="I B.E. IT">I B.E. IT</option>
                                        <option value="II B.E. IT">II B.E. IT</option>
                                        <option value="III B.E. IT">III B.E. IT</option>
                                        <option value="IV B.E. IT">IV B.E. IT</option>


                                        <option value="I B.E. AI&DS">I B.E. AI&DS</option>
                                        <option value="II B.E. AI&DS">II B.E. AI&DS</option>
                                        <option value="III B.E. AI&DS">III B.E. AI&DS</option>
                                        <option value="IV B.E. AI&DS">IV B.E. AI&DS</option>
                        ...
                        <div className="pt-6 border-t border-slate-100">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-sm font-black text-indigo-600 uppercase tracking-widest">Security Questions</h3>
                            </div>
                            <p className="text-xs text-slate-500 mb-4">These answers will be encrypted and used for password recovery. Please remember them.</p>
