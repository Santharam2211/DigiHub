        ...
        <div className="space-y-12 pb-40">
            ...
            <AnimatePresence>
                {showForm && (
                    ...
                    >
                        <h2 className="text-2xl font-black text-slate-900 mb-8">{editingId ? 'Edit Member' : 'New Association Member'}</h2>
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Association Role</label>
                                    <select 
                                        className="input-premium"
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                ...
                                className="flex items-center gap-2 px-5 py-2.5 bg-amber-100 text-amber-700 rounded-xl text-xs font-black hover:bg-amber-200 transition-all"
                            >
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    {member.associationRole && (
                                                        <span className="text-xs text-indigo-600 font-bold mt-1 bg-indigo-50 px-2 py-0.5 rounded w-fit">
                                                            {member.associationRole}
                                                        </span>
                                                    )}
                                                </div>
                                        ...
                                        <td className="px-10 py-6">
                                             <div className="flex items-center gap-3">
                                                <button 
                                                    ...
                                                    className="p-3 text-indigo-600 hover:bg-white rounded-xl transition-all shadow-sm border border-slate-100"
                                                ...
                                                <button 
                                                    ...
                                                    className="p-3 text-red-600 hover:bg-white rounded-xl transition-all shadow-sm border border-slate-100"
                                                    title="Delete Member"
                                                >
