                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button 
                                    ...
                                    className="text-primary-600 text-sm font-bold flex items-center gap-1 hover:bg-primary-50 px-3 py-1 rounded-lg transition-colors border border-primary-100"
                                >
                                            ...
                                            {['dropdown', 'radio', 'checkbox'].includes(field.type) && (
                                                <div className="mt-3 p-3 bg-indigo-50 rounded-xl border border-indigo-100">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-3 py-2 text-sm bg-white border border-indigo-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    ...
                    <section className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex gap-2">
                                <select 
                                    className="text-sm border border-rose-200 rounded-lg px-3 py-1 bg-rose-50 text-rose-700 outline-none focus:ring-2 focus:ring-rose-500 font-bold"
                                    onChange={(e) => {
                                        if (!e.target.value) return;
