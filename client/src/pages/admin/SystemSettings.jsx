            ...
            <div className="space-y-8">
                ...
                >
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-slate-900">Nomination Settings</h2>
                            <p className="text-slate-500 text-sm font-medium">Control nomination form availability</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-2xl">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-black text-slate-900">Enable Nomination Forms</h3>
                                    <p className="text-sm text-slate-500">Allow users to submit nomination forms</p>
                                </div>
                            </div>
                            <button
                            ...
                            >
                                <div className={`absolute top-1 w-6 h-6 rounded-full bg-white transition-transform ${settings.nominationFormsEnabled ? 'translate-x-8' : 'translate-x-1'}`} />
                            </button>
                        </div>
                        ...
                        <div className="p-6 bg-slate-50 rounded-2xl">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    <h3 className="font-black text-slate-900">Volunteer Restriction</h3>
                                    <p className="text-sm text-slate-500">Control who can volunteer for events</p>
                                </div>
                            </div>
                            <div className="space-y-3 mt-4">
                                <label className="flex items-center gap-3 p-4 bg-white rounded-xl cursor-pointer border-2 border-transparent hover:border-primary-200 transition-all">
                                    <input
                                        type="radio"
                                        name="restriction"
                                        value="all"
                                    ...
                                    />
                                    <div>
                                        <p className="font-bold text-slate-900">All Users</p>
                                        <p className="text-xs text-slate-500">Allow eligible users to volunteer anytime</p>
                                    </div>
                                </label>
                                <label className="flex items-center gap-3 p-4 bg-white rounded-xl cursor-pointer border-2 border-transparent hover:border-primary-200 transition-all">
                                    <input
                                    ...
                                    />
                                    <div>
                                        <p className="font-bold text-slate-900">Upcoming Events Only</p>
                                        <p className="text-xs text-slate-500">Only allow volunteering for upcoming events</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                ...
                >
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-slate-900">PDF Report & Header Settings</h2>
                            <p className="text-slate-500 text-sm font-medium">Configure institutional headers and logos for all generated PDF reports (Attendance, Feedback, etc.)</p>
                        </div>
                    </div>

                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-slate-700">Symposium Name</label>
                            <input
                                type="text"
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-slate-700">Symposium Type</label>
                            <input
                                type="text"
                                className="input-premium"
                    ...
                    <div className="grid md:grid-cols-2 gap-8 pt-4">
                        ...
                        <div className="space-y-4">
                            <label className="block text-sm font-bold text-slate-700">Institution Innovation Council (IIC) Logo</label>
                            <div className="flex items-center gap-6">
                                {iicLogoPreview ? (
                                    <div className="w-24 h-24 rounded-2xl border bg-white p-2 overflow-hidden flex items-center justify-center shrink-0">
                                        <img src={iicLogoPreview} className="w-full h-full object-contain" alt="IIC Logo Preview" />
                                    </div>
                                ) : (
                                    <div className="w-24 h-24 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center bg-slate-50 text-slate-400 shrink-0">
                                        <Image className="w-8 h-8" />
                                        <span className="text-[10px] font-bold">No logo</span>
                                    </div>
                                )}
                                <label className="flex-1 py-3 px-4 bg-slate-50 border border-slate-200 hover:bg-slate-100 rounded-xl cursor-pointer flex items-center justify-center gap-2 text-xs font-bold text-slate-700 transition-colors">
                        ...
                        {/* Digiflash Logo */}
                        <div className="space-y-4">
                            <label className="block text-sm font-bold text-slate-700">Digiflash Logo</label>
                            <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-4">
                            <label className="block text-sm font-bold text-slate-700">Association Coordinator Sign</label>
                            <div className="flex items-center gap-6">
                                {assocSignPreview ? (
                                    <div className="w-24 h-24 rounded-2xl border bg-white p-2 overflow-hidden flex items-center justify-center shrink-0">
                        ...
                        {/* HOD Sign */}
                        <div className="space-y-4">
                            <label className="block text-sm font-bold text-slate-700">HOD Sign</label>
                            <div className="flex items-center gap-6">
                                {hodSignPreview ? (
                                    <div className="w-24 h-24 rounded-2xl border bg-white p-2 overflow-hidden flex items-center justify-center shrink-0">
