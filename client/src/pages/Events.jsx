                                    ...
                                    >
                                        <div className="relative h-72 rounded-[2rem] overflow-hidden mb-8">
                                            <img 
                                                ...
                                                alt={event.title}
                                            />
                                            <div className="absolute top-6 left-6 px-4 py-2 bg-white/90 backdrop-blur rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-900 shadow-xl dark:text-white">
                                                {event.category}
                                            </div>
