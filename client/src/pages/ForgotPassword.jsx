...
const ForgotPassword = () => {
    ...
    const handleSecurityAnswersSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const res = await axios.post('http://localhost:5000/api/auth/verify-security-answers', {
                email,
                securityAnswers
            });
            toast.success(res.data.message);
        ...
        <div className="min-h-screen flex items-center justify-center relative py-20 px-6">
            ...
            >
                <div className="text-center space-y-4 mb-12">
                    ...
                    <p className="text-slate-500 font-medium text-lg">Securely recover your account access</p>
                </div>
                ...
                <div className="bg-white rounded-[2.5rem] p-10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] border border-slate-100">
                        ...
                        {step === 2 && (
                            ...
                            >
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <h3 className="text-sm font-black text-indigo-600 uppercase tracking-widest">Security Verification</h3>
                                </div>
                                <p className="text-sm text-slate-500 mb-6">Answer all security questions correctly to proceed.</p>

                                <form onSubmit={handleSecurityAnswersSubmit} className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Best Friend's Name</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Favorite Color</label>
                                        <input
                                            type="text"
                                            className="input-premium text-sm"
                                            placeholder="Enter in one word"
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Favorite Hero Name</label>
                                        <input
                                            type="text"
                                            className="input-premium text-sm"
                                            placeholder="Enter in one word"
                        ...
                        {step === 3 && (
                            ...
                            >
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <h3 className="text-sm font-black text-indigo-600 uppercase tracking-widest">Set New Password</h3>
                                </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-slate-50 text-center">
                        <Link to="/login" className="text-slate-500 font-medium hover:text-indigo-600 inline-flex items-center gap-1 group">
