        ...
        <div className="space-y-12 pb-40">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 relative z-10">
                <div className="space-y-4">
                    ...
                    <h1 className="text-5xl font-black text-slate-900 tracking-tighter leading-tight flex items-center gap-4">
                ...
                <button 
                    ...
                    className={`px-6 py-3 rounded-2xl flex items-center gap-3 shadow-xl transition-all ${
                        isScannerActive 
                        ? 'bg-slate-900 text-white hover:bg-slate-800 border-2 border-transparent' 
                ...
                >
                    ...
                    <span className={`text-xs font-black uppercase tracking-widest ${
                        isScannerActive ? 'text-emerald-400' : 'text-slate-500'
                    }`}>
            ...
            <div className="grid lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-8 flex flex-col">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] relative overflow-hidden">
                        ...
                        <div className="space-y-4 relative z-10">
                            ...
                            <div className="relative">
                                <select
                                    className="w-full px-6 py-4 bg-slate-50 border-2 border-transparent hover:border-indigo-100 focus:border-indigo-500 rounded-2xl appearance-none outline-none transition-all font-bold text-slate-700 cursor-pointer"
                                    value={selectedEvent}
                        ...
                        <div className="space-y-6 h-full flex flex-col justify-center">
                            ...
                            <div className="flex gap-4">
                                <div className="relative flex-1">
                                    ...
                                    <input 
                                        type="text" 
                                        className="w-full pl-14 pr-6 py-4 bg-slate-50 border-2 border-transparent focus:border-slate-300 rounded-2xl outline-none font-medium transition-all"
                    ...
                    {selectedEvent && (
                        <div className="flex flex-col gap-3">
                            <button
                                ...
                                className="w-full flex items-center justify-between px-6 py-4 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-2xl font-bold transition-colors group border border-emerald-100"
                            >
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 px-4 py-4 bg-rose-50 hover:bg-rose-100 text-rose-700 rounded-2xl font-bold transition-colors border border-rose-100"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 px-4 py-4 bg-violet-50 hover:bg-violet-100 text-violet-700 rounded-2xl font-bold transition-colors border border-violet-100"
                                >
                ...
                <div className="lg:col-span-7 relative flex flex-col">
                    <div className="flex-1 bg-slate-900 rounded-[3rem] overflow-hidden relative shadow-[0_20px_50px_-15px_rgba(0,0,0,0.5)] border-[10px] border-slate-800 flex items-center justify-center group min-h-[500px]">
                        ...
                        {isScannerActive ? (
                            ...
                            <div className="absolute inset-0 bg-slate-900 flex flex-col items-center justify-center z-10 border-2 border-dashed border-slate-700 m-4 rounded-[2rem]">
                                <ScanLine className="w-20 h-20 text-slate-700 mb-6" />
                                <p className="text-slate-500 font-black uppercase tracking-widest text-sm">Scanner is offline</p>
                                <p className="text-slate-600 font-medium mt-2 max-w-xs text-center text-xs">Enable scan mode to use the camera, or use the manual override.</p>
                                <button 
                    ...
                    <AnimatePresence>
                        {scanResult && (
                            ...
                            >
                                <div className={`p-6 rounded-[2rem] shadow-2xl backdrop-blur-xl border ${
                                    scanResult.success 
                                    ...
                                    <div className="flex items-center gap-6">
                                        <div className={`w-16 h-16 rounded-full flex items-center justify-center shrink-0 shadow-inner ${
                                            scanResult.success ? 'bg-emerald-500 shadow-emerald-400/50' : 'bg-rose-500 shadow-rose-400/50'
                                        }`}>
