...
const userSchema = new mongoose.Schema({
    ...
    role: {
        type: String,
        enum: ['Participant', 'Association Member', 'Class Coordinator', 'Program Coordinator', 'Admin', 'Faculty', 'Faculty Coordinator', 'Student Coordinator'],
        default: 'Participant'
    },
    membershipStatus: {
        type: String,
    ...
    // For Class Coordinators: Which class they manage
    assignedYear: {
        type: String,
        enum: ['I', 'II', 'III', 'IV'],
        sparse: true
